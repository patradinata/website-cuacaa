...
const ControlsHelp = () => {
  ...
  const toggleHelper = () => {
    setShowHelper((prev) => !prev); // Toggle visibilitas
  };

  return (
    <>
      <div className="absolute top-52 md:right-32 right-24 z-20">
        <button onClick={toggleHelper} className="bg-white text-slate-700 px-4 py-2 rounded-lg shadow-md backdrop-blur-sm hover:bg-purple-200 active:scale-95">
